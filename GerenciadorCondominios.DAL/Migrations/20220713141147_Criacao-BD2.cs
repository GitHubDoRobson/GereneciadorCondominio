...
{
    public partial class CriacaoBD2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EventoId = table.Column<int>(maxLength: 50, nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "253f9306-0e95-4142-889c-7b7b7b7ff1cb", "b266c0c7-b3e4-4a78-9ed4-2bc2b704f4c7", "Morador do prédio", "Morador", "MORADOR" },
                    { "ca1ed808-96df-4a8c-ae0f-cc76b158d375", "9b3cec8a-7808-447b-b5cb-e8537df894f9", "Síndico do prédio", "Síndico", "SÍNDICO" },
                    { "17990ff0-0e1b-48b8-b876-082ee75c9b49", "5cb2b740-a48c-4a5c-b83f-e3f417b899a0", "Administrador do prédio", "Administrador", "ADMINISTRADOR" }
                });
